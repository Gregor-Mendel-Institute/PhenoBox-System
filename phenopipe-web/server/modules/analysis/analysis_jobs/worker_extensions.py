...
def get_status_cache():
    """
    Lazily initialized instance of :class:`~server.utils.redis_status_cache.redis_status_cache.StatusCache` for analysis jobs

    :return: Instance of :class:`~server.utils.redis_status_cache.redis_status_cache.StatusCache`
    """
    if get_status_cache.cache is None:
        get_status_cache.cache = StatusCache(connection=get_redis_connection(), namespace='analysis', ttl=-1)
